...
async function precache() {
  ...
  return cache.addAll(['/', '/index.html', '/assets/ejercicio.mp4', '/assets/css/index.css', '/assets/js/index.js', '/assets/js/mediaPlayer.js', '/assets/js/plugins/AutoPause.js', '/assets/js/plugins/AutoPlay.js']);
}
